...
#     temperature=[data[0:72].mean(),data[72:144].mean(),data[144:216].mean(),data[216:288].mean(),data[288:360].mean(),data[360:432].mean(),data[432:504].mean(),data[504:576].mean(),data[576:648].mean(),data[648:720].mean(),data[720:792].mean(),data[792:864].mean(),data[864:936].mean(),data[936:1008].mean(),data[1008:1080].mean(),data[1080:1152].mean(),data[1152:1224].mean(),data[1224:1296].mean(),data[1296:1368].mean(),data[1368:1440].mean(),data[1440:1512].mean(),data[1512:1584].mean(),data[1584:1656].mean(),data[1656:1728].mean(),data[1728:1800].mean(),data[1800:1872].mean(),data[1872:1944].mean(),data[1944:2016].mean(),data[2016:2088].mean(),data[2088:2160].mean(),data[2160:2232].mean(),data[2232:2304].mean(),data[2304:2376].mean(),data[2376:2448].mean(),data[2448:2476].mean()]
#     dates=["6/10/2020","6/11/2020","6/12/2020","6/13/2020","6/14/2020","6/15/2020","6/16/2020","6/17/2020","6/18/2020","6/19/2020"," 6/20/2020","6/21/2020","6/22/2020","6/23/2020","6/24/2020","6/25/2020","6/26/2020","6/27/2020","6/28/2020","6/29/2020","6/30/2020","7/1/2020","7/2/2020","7/3/2020","7/4/2020","7/5/2020","7/6/2020","7/7/2020","7/8/2020","7/9/2020","7/10/2020","7/11/2020","7/12/2020","7/13/2020","7/14/2020"]
...
# print (average_temperature(dfA[4]))
# print (average_temperature(dfB[4]))
# print (average_temperature(dfC[4]))
# print (average_temperature(dfD[4]))
# print (average_temperature(dfE[4]))
...
def average_temperature(data):
    ...
    df_print=pd.DataFrame(d)
    df_print.sort_values(by=['Temperature','Date'],axis=0,ascending=False)
    print (df_print[df_print.Temperature == df_print.Temperature.max()]) 
    print (df_print[df_print.Temperature == df_print.Temperature.min()])
